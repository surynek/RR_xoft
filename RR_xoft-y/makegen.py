...
# Version: 2.0
# (C) Copyright 2010 - 2022 Pavel Surynek
...
def print_intro():
  ...
  print "(C) Copyright 2010 - 2022 Pavel Surynek"
  print "---------------------------------------"
         ...
         if pd == md.directory:
           for sr in md.sources:
             ...
             if obj not in finished:
               ...
               makefile.write(src + "\n")
               makefile.write("\tg++ -Wall -Wextra -pedantic -Wno-class-memaccess -Wno-long-long -Wno-unused-result -Wno-sign-compare -Wno-delete-non-virtual-dtor -Wno-stringop-truncation -std=c++0x -g -c ")
         ...
         if pd == md.directory:
           for sr in md.sources:
             ...
             if obj not in finished:
               ...
               makefile.write("\tg++ -Wall -Wextra -pedantic -Wno-class-memaccess -Wno-long-long -Wno-unused-result -Wno-sign-compare -Wno-delete-non-virtual-dtor -Wno-stringop-truncation -g -std=c++0x -c ")
               for hdr_dir in header_dirs:
                 makefile.write("-I" + hdr_dir + " ")
               makefile.write("-o" + obj + " " + src + "\n")
               makefile.write("\n")
