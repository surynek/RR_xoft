...
enum sControlPanelProgram_Result
{
    ...
    sCONTROL_PANEL_PROGRAM_CONFIGURATIONS_FILENAMES_FILE_OPEN_ERROR = (sCONTROL_PANEL_PROGRAM_ERROR - 6),
    sCONTROL_PANEL_PROGRAM_JOINT_CONFIGURATIONS_FILE_OPEN_ERROR     = (sCONTROL_PANEL_PROGRAM_ERROR - 7)         
};
